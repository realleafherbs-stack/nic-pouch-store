...
// Static-export routes need ASCII-safe URLs. Generate the semantic portion
// from the normalized display name (brand + flavor + strength), then append a
// stable id suffix so similarly named products can never collide.
