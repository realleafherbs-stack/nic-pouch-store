...
export default function PrivacyPage() {
  return (
    <main className="container info-page">
      <InfoHero
        eyebrow="עודכן לאחרונה · 20.09.2026"
        title="מדיניות פרטיות"
      ...
      <InfoAccordion
        items={[
          ...
          },
          {
            ...
            content: <p>האתר משתמש באחסון תפעולי להפעלת שירותים חיוניים. Google Analytics מקבל אותות מדידה גם לפני אישור עוגיות מדידה, במצב שאינו שומר אותן בדפדפן. אם תבחרו ב״אישור הכול״, נאפשר עוגיות מדידה. אפשר לשנות את הבחירה בכל עת דרך סמל העוגייה באתר. מדידה ללא הסכמה עשויה להופיע בדוחות באופן חלקי או משוער. חסימת אחסון תפעולי דרך הדפדפן עלולה לפגוע בחלק מהפעולות באתר.</p>,
          },
          {
            icon: UserCheck,
            title: "הזכויות שלכם",
